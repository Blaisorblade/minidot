...
Proof.
  ...
  (* all: try solve [intros; simpl in *; inverts_closed; simpl; eauto 15 using Forall_impl, (proj1 closed_upgrade_rec)]. *)
  ...
  (* - *)
  (*   intros; simpl in *; inverts_closed. *)
  (*   eauto 12 using Forall_impl, (proj1 closed_upgrade_rec). *)
  ...
  (*   info_eauto 15 using Forall_impl, (proj1 closed_upgrade_rec). *)
  (*   lets ?: Hindt i k env ___; simpl; info_eauto; *)
  (*     lets ?: Hindt1 i (S k) (VarB 0 :: env) ___; simpl; info_eauto; *)
  (*     lets ?: Hindt2 i (S k) (VarB 0 :: env) ___; simpl; info_eauto; *)
  (*     info_eauto 20 using Forall_impl, (proj1 closed_upgrade_rec). *)
  (*   all: info_eauto. *)

  (*   lets ?: Hindt1 i (S k) (VarB 0 :: env) ___; simpl; *)
  (*   eauto 9 using Forall_impl, (proj1 closed_upgrade_rec). *)
  (*     try (constructors; [eauto | eapply Forall_impl with (P := vr_closed i k); intuition eauto using (proj1 closed_upgrade_rec)]). *)
